...
// import '../../core/app_style.dart';
// import 'verify_number_screen.dart'; // We reuse the OTP screen
...
//     try {
//       // Send the 6-digit recovery OTP to the user's email
...
//           context,
//           MaterialPageRoute(
//             builder: (context) => VerifyEmailScreen(email: email, isRecovery: true),
//           ),
//         );
//       }
...
//         return Scaffold(
//           backgroundColor: AppColors.bgWhite,
//           // CRITICAL: This allows the layout to resize when the keyboard opens
//           resizeToAvoidBottomInset: true,
//           appBar: AppBar(
//             backgroundColor: Colors.transparent,
//             elevation: 0,
//             leading: IconButton(
//               icon: Icon(Icons.arrow_back_ios_new, color: AppColors.colblack, size: 20),
...
//                 // This combination guarantees NO pixel overflow errors.
//                 // It expands to fill the screen, but scrolls if the keyboard is up.
...
//                             // Email Input (Matches Figma buttons)
//                             Container(
//                               height: componentHeight,
//                               alignment: Alignment.center,
//                               decoration: BoxDecoration(
//                                 color: AppColors.inputFill,
//                                 borderRadius: BorderRadius.circular(cornerRadius),
//                                 border: _emailError != null ? Border.all(color: AppColors.errorRed, width: 1.0) : null,
//                               ),
//                               child: TextField(
...
//                                   child: Text(
//                                     _emailError!,
//                                     style: GoogleFonts.poppins(color: AppColors.errorRed, fontSize: 12)
//                                   ),
//                                 ),
//                               ),
...
//                                         height: 24,
//                                         width: 24,
//                                         child: CircularProgressIndicator(color: AppColors.colwhite, strokeWidth: 2)
//                                       )
//                                     : Text(
//                                         "Send Code",
//                                         style: GoogleFonts.poppins(
...
//                             // Pushes everything up cleanly and ensures bottom padding
//                             const Spacer(),
