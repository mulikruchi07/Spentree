...
class FeaturesUnlockedScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final buttonSlideUp = Tween<double>(begin: screenHeight, end: 0.0).animate(
      CurvedAnimation(
        parent: animation,
    ...
    final crownSlide = Tween<Offset>(
      begin: const Offset(-1.5, -0.5),
      end: Offset.zero,
    ).animate(CurvedAnimation(parent: animation, curve: Curves.easeOutCubic));
    final crownRotate = Tween<double>(
      begin: -0.5,
      end: 0.2,
    ).animate(CurvedAnimation(parent: animation, curve: Curves.easeOutCubic));

    final diamondSlide = Tween<Offset>(
      begin: const Offset(1.5, -0.5),
      end: Offset.zero,
    ).animate(CurvedAnimation(parent: animation, curve: Curves.easeOutCubic));
    final diamondRotate = Tween<double>(
      begin: 0.5,
      end: -0.2,
    ).animate(CurvedAnimation(parent: animation, curve: Curves.easeOutCubic));
            ...
            child: AnimatedBuilder(
              ...
              child: Container(
                ...
                padding: EdgeInsets.only(
                  ...
                  left: 24,
                  right: 24,
                  bottom: safePadding.bottom > 0 ? safePadding.bottom + 8 : 38,
                ),
                child: Column(
                  mainAxisSize: MainAxisSize.min,
                  children: [
